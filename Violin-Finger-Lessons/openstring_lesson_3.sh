...
\score {\repeat volta 2 {$note1 $note2 $note3 $note4|$note1 $note2 $note3 $note4|$note1 $note2 $note3 $note4|$note1 $note2 $note3 $note4|$note1 $note2 $note3 $note4|$note1 $note2 $note3 $note4}}
EOF
done
done
done
...
grep -v "r r|r r" |shuf -n 250 openstring.ly >> openstring_lesson_3.ly
